 ...
 * @author oscar
 */
public class Filtrar implements Expresion {
    ...
    public Filtrar(Object array, LinkedList<Expresion> parametros, int linea, int columna) {
        this.array = array;
            ...
            if (parametros.size() == 1) {
                ...
                if (ident instanceof Identificador) {
                    ...
                    if (fun != null) {
                        ...
                        if (arreglo != null) {
                            Map<Integer, Object> filtrar = new Arreglo();
                            int j = 0;
