...
public class Alguno implements Expresion{
    ...
    public Alguno(Object array, LinkedList<Expresion> parametros, int linea, int columna) {
        this.array = array;
    ...
    public Object getValor(TablaSimbolos tabla, JTextArea salida) {
        if (array instanceof Arreglo) {
            if (parametros.size() == 1) {
                ...
                System.err.println("Error, la funcion alguno solo recibe un parametro. Linea: " + linea);
            }
        } else {
            System.err.println("Error, se necesita un arreglo para ejecutar alguno. Línea:" + linea);
        }
        return null;
    }
